...
species_obs <- read.csv('C:/Users/oe247/OneDrive - University of Exeter/PhD/IoS/analysis/5_BEN/BRUVS_analysis/IOS_BEN_BRUVS_analysis/processed_data/IoS_BEN_observations.csv')
## just demersal species
reef_fish <- read.csv('C:/Users/oe247/OneDrive - University of Exeter/PhD/IoS/analysis/5_BEN/BRUVS_analysis/IOS_BEN_BRUVS_analysis/processed_data/IoS_BEN_observations_demerselfish.csv')
## read in lengths data
species_lengths <- read.csv('C:/Users/oe247/OneDrive - University of Exeter/PhD/IoS/analysis/5_BEN/BRUVS_analysis/Lengths/IoS_BEN_Lengths.csv')

## read in processed biomass data
site_biomass <- read.csv('C:/Users/oe247/OneDrive - University of Exeter/PhD/IoS/analysis/5_BEN/BRUVS_analysis/IOS_BEN_BRUVS_analysis/processed_data/IOS_BEN_biomass.csv')
## read in metadata
envo_variables <- read.csv('C:/Users/oe247/OneDrive - University of Exeter/PhD/IoS/analysis/5_BEN/BRUVS_analysis/IOS_BEN_BRUVS_analysis/processed_data/IoS_BEN_metadata.csv')
...
species <- read.csv('C:/Users/oe247/OneDrive - University of Exeter/PhD/IoS/analysis/5_BEN/BRUVS_analysis/IOS_BEN_BRUVS_analysis/processed_data/iNEXT_data_format2.csv')
...
family_habs <- read.csv('C:/Users/oe247/OneDrive - University of Exeter/PhD/IoS/analysis/5_BEN/BRUVS_analysis/IOS_BEN_BRUVS_analysis/processed_data/IoS_BEN_metadata_obs.csv')
...
model5 <- glm(Total_biomass_kg~Remoteness + W_y + Year,data = IOS_data_SAC, family = Gamma(link =log)) model6 <- glm(Total_biomass_kg~Exposure + W_y + Year, data = IOS_data_SAC,  family = Gamma(link =log))

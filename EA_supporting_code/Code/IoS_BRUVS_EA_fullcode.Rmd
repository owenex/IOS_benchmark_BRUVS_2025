...
correlation_matrix <- cor(envo_variables_numeric)
print(correlation_matrix)

## Setting up the model
Richness_model <- glm(Richness ~ Relief_score+Depth+Temp+Rug_range+Remoteness+Exposure+Slope_mean, data = IOS_data)
MaxN_model <- glm(Total_MaxN ~ Relief_score+Depth+Temp+Rug_range+Remoteness+Exposure+Slope_mean, data = IOS_data)
Div_model <- glm(shannon_index ~ Relief_score+Depth+Temp+Rug_range+Remoteness+Exposure+Slope_mean, data = IOS_data)
Biomass_model <- glm(Total_biomass_kg ~ Relief_score+Depth+Temp+Rug_range+Remoteness+Exposure+Slope_mean, data = IOS_data)
...
### rerun omitting mean slope and ruggedness
...
## Setting up the model
Richness_model <- lm(Richness ~ Relief_score+Depth+Temp+Remoteness+Exposure, data = IOS_data)
MaxN_model <- lm(Total_MaxN ~ Relief_score+Depth+Temp+Remoteness+Exposure, data = IOS_data)
Biomass_model <- lm(Total_biomass_kg ~ Relief_score+Depth+Temp+Remoteness+Exposure, data = IOS_data)
